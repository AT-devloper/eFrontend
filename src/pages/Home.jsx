...
// Hero slides with optional category filter
const heroSlides = [
  {
    ...
    category: "All", // Opens all products
  },
  {
    ...
    category: "Necklaces", // Opens products filtered to Necklaces
  },
];
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
      ...
      <Container maxWidth="md" sx={{ py: 15, textAlign: "center" }}>
        <ScrollReveal>
          <Typography variant="overline" sx={{ color: "#D4AF37", letterSpacing: 4, fontWeight: 700 }}>
            NO GEMS. NO DIAMONDS.
          </Typography>
          <Typography variant="h2" sx={{ fontFamily: "'Playfair Display', serif", my: 3 }}>
            The Soul of 22 Karats
          </Typography>
          <Typography
            variant="body1"
            sx={{ color: "#555", lineHeight: 2.2, fontSize: "1.15rem", fontStyle: "italic" }}
          >
              ...
              <ScrollReveal>
                ...
                >
                  <Box
                    component="img"
                    src={item.img}
                    sx={{ width: "100%", height: "100%", objectFit: "cover", transition: "2s ease" }}
                  />
                  <Box
                    sx={{
                      position: "absolute",
                  ...
                  >
                    <Typography variant="h4" sx={{ color: "#fff", fontFamily: "'Playfair Display', serif" }}>
                      {item.name}
                    </Typography>
                  </Box>
                </Box>
        ...
        <Container maxWidth="lg">
          <ScrollReveal>
            <Stack direction={{ xs: "column", md: "row" }} justifyContent="space-between" alignItems="center" spacing={4}>
              ...
              <Button variant="outlined" sx={{ borderColor: "#000", color: "#000", borderRadius: 0, px: 4 }}>
                CHECK PRICE TRENDS
              </Button>
            </Stack>
          </ScrollReveal>
